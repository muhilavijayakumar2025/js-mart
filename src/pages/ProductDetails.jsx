            ...
            <div className="w-full px-12 relative z-10">
                ...
                <div className="flex flex-col items-center justify-center min-h-[70vh]">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                        ...
                        <Link
                            to="/"
                            className="bg-white/10 backdrop-blur-lg border border-white/30 hover:bg-white/20 text-white font-bold px-12 py-4 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-3"
                        >
