...
const Home = () => {
    ...
    return (
        <div className="flex flex-col">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            ...
                            <div key={index} className="group relative">
                                <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-primary-200 transform hover:-translate-y-2 h-full">
                                    <div className={`${feature.bg} w-20 h-20 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                        {feature.icon}
                                    </div>
            ...
            <section id="offers" className="py-24 bg-gradient-to-br from-primary-900 via-primary-800 to-green-900 text-white relative overflow-hidden">
                <div className="absolute inset-0">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-primary-700 rounded-full blur-3xl opacity-20"></div>
                    <div className="absolute bottom-0 left-0 w-96 h-96 bg-green-700 rounded-full blur-3xl opacity-20"></div>
                </div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-6">
                            <Sparkles className="h-5 w-5 text-yellow-400" />
                            <span className="font-bold text-sm uppercase tracking-wider">Weekly Specials</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-black mb-4">Weekly Specials & New Arrivals</h2>
                        <p className="text-xl text-primary-200">Visit us in-store to discover our latest offers!</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: '🛒', title: 'Farm-fresh fruits & vegetables', desc: 'at great prices' },
                            { icon: '🥛', title: 'Daily essentials', desc: 'always in stock' },
                            { icon: '🇦🇺', title: 'Katoomba Foods products', desc: 'arriving soon' },
                            { icon: '✨', title: 'Fresh stock', desc: 'added regularly' },
                        ].map((offer, index) => (
                            <div key={index} className="bg-white/10 backdrop-blur-lg p-6 rounded-3xl border-2 border-white/20 h-full flex flex-col hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                                <div className="text-5xl mb-4">{offer.icon}</div>
                                <h3 className="text-xl font-black mb-2">{offer.title}</h3>
                                <p className="text-primary-100 text-sm">{offer.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-100 rounded-full mb-6">
                            ...
                            <span className="text-primary-700 font-bold text-sm uppercase tracking-wider">Premium Quality</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
                            Fresh From <span className="text-primary-600">Farm</span>
                        </h2>
                        <p className="text-xl text-gray-600">Top selling products this week - Handpicked for you</p>
                    </div>
            ...
            <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-br from-primary-600 via-primary-500 to-green-600 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl">
                        {/* Background Pattern */}
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <a href="#products" className="inline-flex items-center gap-3 bg-white text-primary-600 px-12 py-5 rounded-2xl font-black text-xl hover:bg-primary-50 transition-all shadow-2xl hover:shadow-3xl transform hover:scale-105">
            ...
            <section id="about" className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="inline-block px-6 py-2 bg-primary-100 rounded-full text-sm font-bold mb-4 uppercase tracking-wider">About Us</span>
                        <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6">About <span className="text-primary-600">JS Mart</span></h2>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
                        ...
                        <div className="lg:w-1/2 space-y-8">
                            <h3 className="text-4xl font-extrabold text-gray-900 leading-tight">Your Trusted Multicultural Grocery Store</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gradient-to-br from-primary-50 to-white p-12 rounded-3xl shadow-lg border border-gray-100">
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-white p-12 rounded-3xl shadow-lg border border-gray-100">
                            <div className="bg-green-100 h-16 w-16 rounded-2xl flex items-center justify-center mb-8">
            ...
            <section id="contact" className="py-24 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <span className="inline-block py-2 px-4 rounded-full bg-primary-100 text-primary-700 text-sm font-semibold mb-6">
                            24/7 Support
                        </span>
                        <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6">Visit Us Today</h2>
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-12">
                            <h3 className="text-3xl font-black text-gray-900 mb-4">Contact Details</h3>
                                ...
                                >
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-gray-400 font-medium mt-3">{info.desc}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
